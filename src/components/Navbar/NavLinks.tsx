      ...
      sublinks: [
        {
          ...
          sublink: [
            ...
            { name: t.head1sub2, link: "/2" },
            { name: t.head1sub3, link: "/3" },
          ],
        },
        {
          Head: t.head2,
          sublink: [
            { name: t.head2sub1, link: "/1" },
            { name: t.head2sub2, link: "/2" },
          ],
        },
        {
          Head: t.head3,
          sublink: [
            { name: t.head3sub1, link: "/1" },
            { name: t.head3sub2, link: "/2" },
          ],
        },
      ],
    },
                    ...
                    <div className={`${subHeading === slinks.Head ? "md:hidden" : "hidden"}`}>
                      {
                        slinks.sublink.map((slink)=> (
                          <li key={slink.link} className="py-3 pl-14">
                            <Link href={slink.link} className="hover:text-primary">{slink.name}</Link>
                          </li>
                        ))
                      }
                    </div>
