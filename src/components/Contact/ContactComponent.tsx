        ...
        <div className="flex flex-wrap -mx-4 lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <div className="flex">
                ...
                <select
                  id="contactLocation"
                  className="bg-gray-50 border-2 border-primary text-gray-700 max-h-8 text-sm
                  rounded-lg focus:ring-primary focus:border-primary md:block md:w-fit ml-2"
                  onChange={changeContactLanguage}
              ...
              <div className="mb-8 flex w-full max-w-[380px]">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            ...
            <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12 border-2 border-gray-500">
              ...
              <div>
                <span className="absolute -top-10 -right-9 z-[-5]">
                  <svg
                    width={100}
                    height={100}
                    viewBox="0 0 100 100"
                ...
                <span className="absolute -right-10 top-[90px] z-[-5]">
                  <svg
                    width={34}
                    height={134}
                    viewBox="0 0 34 134"
                ...
                <span className="absolute -left-7 -bottom-7 z-[-5]">
                  <svg
                    width={107}
                    height={134}
                    viewBox="0 0 107 134"
...
type ContactInputBox = {
  type: any;
  placeholder: any;
  name: any;
};

const ContactTextArea = (props: ContactTextArea) => {
...
const ContactInputBox = (props: ContactInputBox) => {
