      ...
      <div className="container">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="w-full mb-10 mt-[-20vh]">
              <Link href="/#" className="inline-block max-w-full ">
                <Image
                  ...
                  width={300}
                  height={200}
                  className="h-auto md:object-cover object-none ml-[-1.5rem] sm:mt-10 md:mt-0"
                />
              </Link>
              ...
              <p className="flex items-center text-sm font-medium text-dark">
                ...
                <span>
                  (+31) 085 - 020 7800 <br /> (Mobiel) (+31) 06 46 90 33 90
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="w-fit sm:w-1/2 lg:w-3/12">
            <div className="w-fit">
              ...
              <p className="normal-break italic text-sm">
                Website by :{" "}
                <Link
                  href="https://www.milanvdl.nl"
