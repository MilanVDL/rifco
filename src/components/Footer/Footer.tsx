            ...
            <div className="w-fit sm:w-1/2 lg:w-3/12">
              <div className="w-fit">
                <p className="text-base text-body-color">
                  {" "}
                  © {new Date().getFullYear()} Rifco Bv{" "}
                </p>
                <p className="normal-break italic text-sm">Website by : <Link href="https://www.milanvdl.nl" rel="noopener noreferrer" target="_blank" className="not-italic" >Milan van der Linden</Link></p>
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stopColor="#4689a0" stopOpacity="0.420" />
                  <stop offset={1} stopColor="#C4C4C4" stopOpacity={0.2} />
                </linearGradient>
              </defs>
            </svg>
          </span>
...
const LinkGroup = (props: LinkGroup) => {
