...
export default {
  ...
  p5: "The fact that RIFCO's specific cost-saving cleaning approach works translates into the fact that RIFCO now cleans many thousands of squar meters of floor space in data center, but also in smaller computer and server rooms",
