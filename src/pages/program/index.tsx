...
import TextImage from "../../../public/Program_foto.jpg";
...
const Program = () => {
  ...
  return (
    <div>
      <Navbar />
      <PageBanner />
      <div className="h-[100%] w-[80vw] ml-[10vw] flex md:flex-row flex-col md:mt-12 mt-10 mb-32 md:mb-0">
        ...
        <div className="md:w-[30vw] ml-2 mt-20 md:mt-0 md:ml-32">
          <Image
            ...
            alt="test"
            src={TextImage}
            className="w-full max-h-[30vw] object-none rounded-xl"
          />
        </div>
      </div>
      <Footer />
