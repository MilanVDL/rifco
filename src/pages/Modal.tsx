...
const Modal = () => {
  return (
    <div className="w-screen h-screen absolute">
      <div className="w-screen h-screen bg-gray-500 opacity-25 z-10 absolute"></div>
      <div className="w-[70vw] ml-[15vw] h-auto mt-[10vh] bg-white grid grid-cols-1 md:grid-cols-2 rounded-xl absolute pb-[2rem] z-20">
        <AiOutlineClose
          size={24}
